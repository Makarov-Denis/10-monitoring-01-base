# Домашнее задание к занятию "`13.Системы мониторинга`" - `Макаров Денис`
...
![1](https://github.com/user-attachments/assets/f83d735d-105f-4fd6-b547-e692b97220cb)
...
![2](https://github.com/user-attachments/assets/55dc1284-886e-4bbc-a0dd-0ded1066a01b)
...
```
![3](https://github.com/user-attachments/assets/8cd5b0bc-576b-4684-ba0b-3b985915cb92)
...
```
  telegraf:
    ...
    ports:
      ...
      - "8125:8125/udp"
```
![4](https://github.com/user-attachments/assets/6b22b5c7-c638-4359-92a8-2059d102a0a3)

После настройке перезапустите telegraf, обновите веб интерфейс и приведите скриншотом список `measurments` в 
веб-интерфейсе базы telegraf.autogen . Там должны появиться метрики, связанные с docker.

![5](https://github.com/user-attachments/assets/2768cf52-95af-4252-918d-053b6ab86ef2)
